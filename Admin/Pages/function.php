                        ...
                        <div id="mymodal" class="modal fade">
                            ...
                            <!-- Modal content-->
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" method="post" id="product_form" onSubmit="return form_submit('Pages/function.php?add_product=ok','product_form','?mycat=add_product')">
                                            <div class="form-group">
                                     	<label class="col-sm-4 control-label">Select Main Category</label>
                                     	<div class="col-sm-8">
                                     		<select name="main_cat" class="form-control" onChange="get_option(this.value,'get_category','main_cat_id','cat');">
									...
									while($data=mysql_fetch_assoc($q_e))
									{
                                        ...
                                        <td>
                                         ...
                                         <td class="cat-btn">
                                            ...
                                            <a href="Pages/function.php?vendor=vendor_list&vendor_id=<?php echo $data['id'] ?>&update=<?php echo $data['status'] ?>"><button class="btn btn-success btn-xs pull-right btn-labeled" data-toggle="modal" data-target="#edit_cat_modal" style="margin-right:4px"><i class="fa fa-check"></i> Approve</button></a>
                                           <a href="Pages/function.php?vendor=vendor_list&vendor_id=<?php echo $data['id'] ?>&update1=<?php echo $data['status'] ?>"><button class="btn btn-default btn-xs pull-right btn-labeled" data-toggle="modal" data-target="#edit_cat_modal" style="margin-right:4px"><i class="icon-eye-close"></i> Disapprove</button></a>
                            ...
                            <?php
								if(isset($_GET['vendor_id']))
								{
									if(isset($_GET['update']))
									{
										...
										$qry = "UPDATE register_vendor
												SET status='approve' WHERE id='".$_GET['vendor_id']."'";
								...
								if(isset($_GET['vendor_id']))
								{
									if(isset($_GET['update1']))
									{
										...
										echo $status;
										$qry = "UPDATE register_vendor
												SET status='disapprove' WHERE id='".$_GET['vendor_id']."'";
										$result=mysql_query($qry);
										if($result)
										{
											echo "success";
